...
#   python -m PyInstaller --noconsole --onefile OffboardV17.py
...
# NEW: Global button to clear the persistent Selected Users bucket
...
def dock_clear_all():
    # This calls the same logic as the global button to keep behavior consistent
